...
import Conversation from "./chat-leftsidebar/Conversation";
import OnlineFriend from "./chat-leftsidebar/OnlineFriend";
function FriendList() {
  return (
    <>
      {/* title */}
      ...
      <div className="scrollbar-config h-[calc(100vh_-_270px)] overflow-auto scroll-smooth focus:scroll-auto">
        <ul>
