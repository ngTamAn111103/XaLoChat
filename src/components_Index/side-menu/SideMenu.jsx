...
export function SideMenu() {
  return (
    ...
    <div className="side-menu  mr-1  flex   flex-col bg-white shadow-black
    h-full
    min-h-[100vh]  
    min-w-[75px]  
    max-w-[75px]
    ">
      ...
      <div className="my-auto box-border">
        <ul className=" side-menu-nav  nav-pills nav mb-0 mt-0 flex list-none flex-col flex-wrap justify-center pl-0" role="tablist">
