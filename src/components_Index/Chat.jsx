export function Chat() {
  return (
    <>
      ...
      <div className="flex mb-5 items-start gap-2.5">
                  <img
                    className="h-8 w-8 rounded-full"
                    src="/images/320186702_823742058729606_3659513607149413256_n.jpg"
                    alt="Jese image"
                  />
                  <div className="leading-1.5 border-gray-200 bg-gray-100 dark:bg-gray-700 flex w-full max-w-[320px] flex-col rounded-e-xl rounded-es-xl bg-primary p-4">
                  ...
                  <button
                    ...
                    className="text-gray-900 hover:bg-gray-100 focus:ring-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-600 inline-flex items-center self-center rounded-lg bg-white p-2 text-center text-sm font-medium focus:outline-none focus:ring-4 dark:text-white"
                    type="button"
                  >
                    <svg
                  ...
                  <div
                    id="dropdownDots"
                    className="divide-gray-100 dark:bg-gray-700 dark:divide-gray-600 z-10 hidden w-40 divide-y rounded-lg bg-white shadow"
                  >
                    <ul
...
<img
  ...
  alt="User Avatar"
/>
<div className="font-medium">Tiên</div>
</div>
